...
public class LBSMessage implements Serializable{
	...
	private ArrayList<Object> addtionArrayList = new ArrayList<Object>();
	...
	public ArrayList<Object> getAddtionArrayList() {
		return addtionArrayList;
	}

	public void setAddtionArrayList(ArrayList<Object> addtionArrayList) {
		this.addtionArrayList = addtionArrayList;
	}
